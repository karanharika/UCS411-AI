""" Written by: Karanveer Singh Harika
    Roll No: 102483034
   This code uses Steepest Hill Climbing Search algorithm to find the optimal solution"""
import copy
...
def search(g):
    ...
    while 1:
        ...
        best_heuristic = 1000  # using this variable to find the best/smallest heuristic from next nodes
        ...
        for child in children_list:
            ...
            if heuristic(child, g) < best_heuristic:
                curr_state = child
        ...
        if len(q) == 0 or heuristic_score >= check:
